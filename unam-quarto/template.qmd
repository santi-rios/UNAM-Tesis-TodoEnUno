...
En la @tbl-comparacion \todo{ejemplo de tabla renderizada con R}, se presentan las diferencias clave entre el narcisista encubierto y el narcisista evidente. Mientras que el narcisista evidente muestra abiertamente su grandiosidad y necesidad de admiración, el narcisista encubierto lo hace de manera más sutil, a través de la victimización y la manipulación pasiva.
...
Y luego puedes incluir el resultado en tu texto \todo{Esto se hace de manera automática, por lo que si cambias tus datos, el reporte se actualiza automáticamente.}:
