...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#| label: fig{-}side}
\CommentTok{\#| fig{-}cap: "This legend would be placed at the side of the figure, rather than below it."}
\CommentTok{\#| fig{-}env: "SCfigure*"}
\CommentTok{\#| echo: false}
\CommentTok{\# tell it the options as comments with a | and a space, as above.}
\CommentTok{\# set echo: false to avoid printing this text}
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{include\_graphics}\NormalTok{(}\StringTok{\textquotesingle{}figs/frog.pdf\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
